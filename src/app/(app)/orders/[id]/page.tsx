...
export default function OrderDetailPage({ params }: Props) {
  ...
  // Not logged in and no guest email — cannot authorize order view
            ...
            <CardContent className="p-6">
              <div className="text-center py-12 space-y-4">
                <p className="text-gray-700">
                  Sign in to view this order, or open the confirmation link from your email
                  (it includes your email address in the URL).
                </p>
                <div className="flex gap-3 justify-center">
                  <Button asChild>
                    <Link href={`/sign-in?redirect=/orders/${id}`}>Sign in</Link>
                  </Button>
