...
export default async function VendorPage({ params }: Props) {
  ...
  try {
    ...
    console.log("✅ Template resolved:", {
      ...
      primaryColor: resolvedTemplate?.templateConfig?.colors?.primary,
      background: resolvedTemplate?.templateConfig?.colors?.background,
    });
  } catch (error) {
  ...
  return (
    <div 
      ...
      style={{
        ...(resolvedTemplate?.cssVariables as React.CSSProperties),
      }}
    >
      <style>{`
        ${cssVariables ? `:root {
            ...
            <div className="flex items-center justify-between gap-4 py-2">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                {productsData.totalDocs > 0 && (
                  ...
                  >
                    {productsData.totalDocs} {productsData.totalDocs === 1 ? 'Product' : 'Products'}
                  </span>
                )}
              </div>
      ...
      >
        <div className="mx-auto">
          {productsData.docs.length === 0 ? (
            <div 
              className="text-center py-12 rounded-lg vendor-info-header"
            >
              <p 
                className="text-lg"
            ...
            <div>
              ...
              >
                Products ({productsData.totalDocs})
              </h2>
              <ProductsList 
